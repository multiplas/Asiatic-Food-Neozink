...
if( ! defined( 'PGAFU_VERSION' ) ) {
	define( 'PGAFU_VERSION', '1.4.2' ); // Version of plugin
}
...
if( ! defined( 'PGAFU_PLUGIN_LINK' ) ) {
    define( 'PGAFU_PLUGIN_LINK', 'https://www.essentialplugin.com/wordpress-plugin/post-grid-filter-ultimate/?utm_source=WP&utm_medium=Post-Grid-and-Filter&utm_campaign=Features-PRO' ); // Plugin link
}
