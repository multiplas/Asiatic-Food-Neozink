					...
					<div class="meta-box-sortables">
						<div class="postbox wpos-pro-box">
							...
							<div class="inside">
								...
								<a class="button button-primary wpos-button-full" href="<?php echo PGAFU_SITE_LINK ?>/pricing/?ref=WposPratik&utm_source=WP&utm_medium=Post-Grid-and-Filter&utm_campaign=Upgrade-PRO" target="_blank"><?php _e('Go Premium', 'post-grid-and-filter-ultimate'); ?></a>
